...
function HomePage({ productCategories }) {
  let showGategory = (categories) => {
    if (Object.keys(categories).length == 0) {
      return "The category list is empety! May be you forgot run 'server-json -p 4000 db.json or changed baseUrl' ?";
    }
    ...
    <div className="container">
      <main className="main">
        <div className="titleOne">
          Welcome to my SSR Rendering with daynamic paramiter example
        </div>
